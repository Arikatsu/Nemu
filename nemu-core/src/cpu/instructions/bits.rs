...
pub(in crate::cpu) fn rlc_r8<B: Bus>(cpu: &mut Cpu<B>, reg: Reg8) -> u8 {
...
pub(in crate::cpu) fn rlc_mem_hl<B: Bus>(cpu: &mut Cpu<B>) -> u8 {
    let hl = cpu.regs.hl();
    let value = cpu.memory.borrow().read(hl);
    let carry = (value & 0x80) != 0;
    let result = (value << 1) | carry as u8;
    cpu.memory.borrow_mut().write(hl, result);
...
pub(in crate::cpu) fn rrc_r8<B: Bus>(cpu: &mut Cpu<B>, reg: Reg8) -> u8 {
    let value = cpu.regs.read_reg8(reg);
...
pub(in crate::cpu) fn rrc_mem_hl<B: Bus>(cpu: &mut Cpu<B>) -> u8 {
    let hl = cpu.regs.hl();
    let value = cpu.memory.borrow().read(hl);
    let carry = (value & 0x01) != 0;
    let result = (value >> 1) | ((carry as u8) << 7);
...
pub(in crate::cpu) fn rl_r8<B: Bus>(cpu: &mut Cpu<B>, reg: Reg8) -> u8 {
    let value = cpu.regs.read_reg8(reg);
    let carry = cpu.regs.carry_flag();
...
pub(in crate::cpu) fn rl_mem_hl<B: Bus>(cpu: &mut Cpu<B>) -> u8 {
    let hl = cpu.regs.hl();
    let value = cpu.memory.borrow().read(hl);
    let carry = cpu.regs.carry_flag();
    let new_carry = (value & 0x80) != 0;
...
pub(in crate::cpu) fn rr_r8<B: Bus>(cpu: &mut Cpu<B>, reg: Reg8) -> u8 {
    let value = cpu.regs.read_reg8(reg);
    let carry = cpu.regs.carry_flag();
...
pub(in crate::cpu) fn rr_mem_hl<B: Bus>(cpu: &mut Cpu<B>) -> u8 {
    let hl = cpu.regs.hl();
    let value = cpu.memory.borrow().read(hl);
    let carry = cpu.regs.carry_flag();
    let new_carry = (value & 0x01) != 0;
...
pub(in crate::cpu) fn sla_r8<B: Bus>(cpu: &mut Cpu<B>, reg: Reg8) -> u8 {
    let value = cpu.regs.read_reg8(reg);
    let carry = (value & 0x80) != 0;
    let result = value << 1;
    cpu.regs.write_reg8(reg, result);
...
pub(in crate::cpu) fn sla_mem_hl<B: Bus>(cpu: &mut Cpu<B>) -> u8 {
    let hl = cpu.regs.hl();
    let value = cpu.memory.borrow().read(hl);
    let carry = (value & 0x80) != 0;
    let result = value << 1;
...
pub(in crate::cpu) fn sra_r8<B: Bus>(cpu: &mut Cpu<B>, reg: Reg8) -> u8 {
    let value = cpu.regs.read_reg8(reg);
    let carry = (value & 0x01) != 0;
    let msb = value & 0x80;
...
pub(in crate::cpu) fn sra_mem_hl<B: Bus>(cpu: &mut Cpu<B>) -> u8 {
    let hl = cpu.regs.hl();
    let value = cpu.memory.borrow().read(hl);
    let carry = (value & 0x01) != 0;
    let msb = value & 0x80;
...
pub(in crate::cpu) fn srl_r8<B: Bus>(cpu: &mut Cpu<B>, reg: Reg8) -> u8 {
    let value = cpu.regs.read_reg8(reg);
    let carry = (value & 0x01) != 0;
    let result = value >> 1;
    cpu.regs.write_reg8(reg, result);
...
pub(in crate::cpu) fn srl_mem_hl<B: Bus>(cpu: &mut Cpu<B>) -> u8 {
    let hl = cpu.regs.hl();
    let value = cpu.memory.borrow().read(hl);
    let carry = (value & 0x01) != 0;
    let result = value >> 1;
...
pub(in crate::cpu) fn swap_r8<B: Bus>(cpu: &mut Cpu<B>, reg: Reg8) -> u8 {
    let value = cpu.regs.read_reg8(reg);
...
pub(in crate::cpu) fn swap_mem_hl<B: Bus>(cpu: &mut Cpu<B>) -> u8 {
    let hl = cpu.regs.hl();
    let value = cpu.memory.borrow().read(hl);
    let result = (value << 4) | (value >> 4);
    cpu.memory.borrow_mut().write(hl, result);
...
pub(in crate::cpu) fn bit_imm3_r8<B: Bus>(cpu: &mut Cpu<B>, bit: u8, reg: Reg8) -> u8 {
    let value = cpu.regs.read_reg8(reg);
    let mask = 1 << bit;
...
pub(in crate::cpu) fn bit_imm3_mem_hl<B: Bus>(cpu: &mut Cpu<B>, bit: u8) -> u8 {
    let hl = cpu.regs.hl();
    let value = cpu.memory.borrow().read(hl);
    let mask = 1 << bit;
    let result = (value & mask) == 0;
...
pub(in crate::cpu) fn res_imm3_r8<B: Bus>(cpu: &mut Cpu<B>, bit: u8, reg: Reg8) -> u8 {
    let value = cpu.regs.read_reg8(reg);
    let mask = !(1 << bit);
...
pub(in crate::cpu) fn res_imm3_mem_hl<B: Bus>(cpu: &mut Cpu<B>, bit: u8) -> u8 {
    let hl = cpu.regs.hl();
    let value = cpu.memory.borrow().read(hl);
    let mask = !(1 << bit);
    let result = value & mask;
...
pub(in crate::cpu) fn set_imm3_r8<B: Bus>(cpu: &mut Cpu<B>, bit: u8, reg: Reg8) -> u8 {
    let value = cpu.regs.read_reg8(reg);
    let mask = 1 << bit;
    let result = value | mask;
    cpu.regs.write_reg8(reg, result);
...
pub(in crate::cpu) fn set_imm3_mem_hl<B: Bus>(cpu: &mut Cpu<B>, bit: u8) -> u8 {
    let hl = cpu.regs.hl();
    let value = cpu.memory.borrow().read(hl);
    let mask = 1 << bit;
    let result = value | mask;
