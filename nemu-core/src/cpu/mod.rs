...
impl<B: Bus> Cpu<B> {
    ...
    fn execute(&mut self, opcode: u8) -> u8 {
        match opcode {
            ...
            0x1F => rra(self),
            0x20 => jr_cond_imm8(self, JumpCond::NZ),
            ...
            0x27 => daa(self),
            0x28 => jr_cond_imm8(self, JumpCond::Z),
            ...
            0x2F => cpl(self),
            0x30 => jr_cond_imm8(self, JumpCond::NC),
            0x31 => ld_sp_imm16(self),
            0x32 => ld_mem_hld_a(self),
            0x33 => inc_sp(self),
            0x34 => inc_mem_hl(self),
            0x35 => dec_mem_hl(self),
            0x36 => ld_mem_r16_imm8(self, Reg16::HL),
            0x37 => scf(self),
            0x38 => jr_cond_imm8(self, JumpCond::C),
            0x39 => add_hl_sp(self),
            ...
            0x7E => ld_r8_mem_r16(self, Reg8::A, Reg16::HL),
            0x7F => 4, // LD A, A
            ...
            0xC0 => ret_cond(self, JumpCond::NZ),
            0xC1 => pop_r16(self, Reg16::BC),
            0xC2 => jp_cond_imm16(self, JumpCond::NZ),
            0xC3 => jp_imm16(self),
            0xC4 => call_cond_imm16(self, JumpCond::NZ),
            ...
            0xCE => adc_imm8(self),
            0xCF => rst(self, 0x08),
            0xD0 => ret_cond(self, JumpCond::NC),
            0xD1 => pop_r16(self, Reg16::DE),
            0xD2 => jp_cond_imm16(self, JumpCond::NC),
            // 0xD3 => UNUSED
            0xD4 => call_cond_imm16(self, JumpCond::NC),
            0xD5 => push_r16(self, Reg16::DE),
            0xD6 => sub_imm8(self),
            0xD7 => rst(self, 0x10),
            0xD8 => ret_cond(self, JumpCond::C),
            0xD9 => reti(self),
            0xDA => jp_cond_imm16(self, JumpCond::C),
            // 0xDB => UNUSED
            0xDC => call_cond_imm16(self, JumpCond::C),
            // 0xDD => UNUSED
            0xDE => sbc_imm8(self),
            0xDF => rst(self, 0x18),
    ...
    #[inline]
    fn reg_cb(&self, code: u8) -> Option<Reg8> {
        match code & 0x07 {
            0 => Some(Reg8::B),
            1 => Some(Reg8::C),
            2 => Some(Reg8::D),
